...
BasicsImProcessing imageProcessing;
...
void setup() {
  ...
  imageProcessing= new BasicsImProcessing(this);
...
void draw() {
  ...
  if (!gamePaused) {
        ...
        rX = imageProcessing.rotations.x + 2 * rX;
        rZ= imageProcessing.rotations.z + 2 * rZ;
        rX *= 0.4;
        rZ *= 0.4;
      }
      mover.update(rX, rZ);
